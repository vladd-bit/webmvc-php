...
<script type="text/javascript" src="<?php echo PUBLIC_FOLDER_URL; ?>/media/js/libraries/material-components-web/material-components-web.min.js"></script>
<script type="text/javascript" src="<?php echo PUBLIC_FOLDER_URL; ?>/media/js/libraries/material-components-web/mdc.autoInit.min.js"></script>
